...
def read_odim_h5(filename, field_names=None, additional_metadata=None,
    ...
    include_datasets : list or None, optional
        List of datasets to include from the HDF5 file. Set
        to None to include all datasets not specified by exclude_datasets.
    exclude_datasets : list or None, optional
        List of datsets to exclude from the HDF5 file. Set
        to None to include all datasets specified by include_datasets.
